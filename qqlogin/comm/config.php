 ...
 */
//申请到的appid
$_SESSION["appid"]    = 101476236;

//申请到的appkey
$_SESSION["appkey"]   = "e1163db3cbdcda060b4dcadc0a7f1312";

//QQ登录成功后跳转的地址,请确保地址真实可用，否则会导致登录失败。http://shop.vipelephant.cn/qqlogin/oauth/qq_callback
$_SESSION["callback"] = "http://shop.vipelephant.cn/qqlogin/oauth/qq_callback.php";
